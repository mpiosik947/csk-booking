  ...
  perform pg_temp.record_result(26, 'Only approved tenant authorization helpers are SECURITY DEFINER',
    ...
    and not exists(
      ...
      where namespace.nspname='public' and procedure.prosecdef
        ...
        and procedure.proname not in ('is_tenant_member_v1','has_tenant_role_v1','get_my_tenant_role_v1','active_single_tenant_id_v1','is_active_public_tenant_v1','get_my_active_tenant_verification_v1')
    ),
