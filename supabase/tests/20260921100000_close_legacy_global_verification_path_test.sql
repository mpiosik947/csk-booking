...
begin
  ...
  perform pg_temp.ok(2,'SECURITY DEFINER count is 76 after 9E-C1',(select pg_catalog.count(*)=76 from pg_catalog.pg_proc procedure_record join pg_catalog.pg_namespace namespace_record on namespace_record.oid=procedure_record.pronamespace where namespace_record.nspname='public' and procedure_record.prosecdef));
