...
begin
  ...
  perform pg_temp.ok(2,'SECURITY DEFINER count is 75 after PRODUCT-10A public directory',(select pg_catalog.count(*)=75 from pg_catalog.pg_proc procedure_record join pg_catalog.pg_namespace namespace_record on namespace_record.oid=procedure_record.pronamespace where namespace_record.nspname='public' and procedure_record.prosecdef));
  ...
  perform pg_temp.ok(32,'Admin Users reader remains unchanged',pg_catalog.md5(pg_catalog.replace(pg_catalog.replace(pg_catalog.pg_get_functiondef('public.admin_list_users_v2(uuid,integer,integer,text,text,text,text)'::regprocedure),pg_catalog.chr(13)||pg_catalog.chr(10),pg_catalog.chr(10)),pg_catalog.chr(13),pg_catalog.chr(10)))='7333cc06535c24927ceaf4bd4643b690');
