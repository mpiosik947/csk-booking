...
begin
  ...
  perform pg_temp.ok(2,'SECURITY DEFINER count is 96 after Phase 2',(select pg_catalog.count(*)=96 from pg_catalog.pg_proc procedure_record join pg_catalog.pg_namespace namespace_record on namespace_record.oid=procedure_record.pronamespace where namespace_record.nspname='public' and procedure_record.prosecdef));
  ...
  perform pg_temp.ok(4,'hardened profile trigger fingerprint unchanged',pg_catalog.md5(pg_catalog.replace(pg_catalog.replace(pg_catalog.pg_get_functiondef('public.prevent_non_admin_profile_privilege_changes()'::regprocedure),pg_catalog.chr(13)||pg_catalog.chr(10),pg_catalog.chr(10)),pg_catalog.chr(13),pg_catalog.chr(10)))='8a3cb4dc2d663cbf3c866fc3d9c8dac7');
