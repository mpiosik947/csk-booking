...
begin
  insert into saas9h_results values
    ...
    (3,'SECURITY DEFINER inventory remains 74',(select count(*)=74 from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='public' and p.prosecdef),'inventory changed'),
