...
begin
  ...
  perform pg_temp.ok(5,'SECURITY DEFINER inventory is 100',(select count(*)=  100 from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='public' and p.prosecdef),'inventory differs');
