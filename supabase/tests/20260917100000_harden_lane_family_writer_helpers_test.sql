...
begin
  ...
  perform pg_temp.ok(5,'SECURITY DEFINER count is 96 after Phase 2',(select count(*)=96 from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='public' and p.prosecdef),'Definer count differs.');
