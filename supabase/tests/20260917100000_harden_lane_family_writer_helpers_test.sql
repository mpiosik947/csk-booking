...
begin
  ...
  perform pg_temp.ok(5,'SECURITY DEFINER count is exactly 67',(select count(*)=67 from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='public' and p.prosecdef),'Definer count differs.');
