...
begin
  ...
  perform pg_temp.ok(2,'100 definers',(select count(*)=  100 from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='public' and p.prosecdef),'DEFINER');
