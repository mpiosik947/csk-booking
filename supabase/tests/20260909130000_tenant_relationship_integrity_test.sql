...
begin
  ...
  perform pg_temp.ok(45,'critical RPC fingerprints match the current tenant-aware contracts',pg_catalog.md5(pg_catalog.pg_get_functiondef('public.get_my_role()'::regprocedure))='dc8858eed7d2fd2d1ab47d22b0000b06' and pg_catalog.md5(pg_catalog.pg_get_functiondef('public.create_reservation_v2(uuid,date,time without time zone,integer,integer,uuid,text)'::regprocedure))='ff1c273379e9ee3af3a1a60d131af81b','Critical RPC changed.');
