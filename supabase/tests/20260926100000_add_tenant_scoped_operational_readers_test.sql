...
begin
  ...
  perform pg_temp.ok(5,'definer inventory is 76 and bridge definitions 22',
    (select count(*)=76 from pg_catalog.pg_proc p join pg_catalog.pg_namespace n on n.oid=p.pronamespace
