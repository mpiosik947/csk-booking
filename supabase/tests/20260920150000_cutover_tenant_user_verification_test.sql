...
begin
  ...
  perform pg_temp.ok(2,'SECURITY DEFINER count is 70 after 9E-A',(select count(*)=70 from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='public' and p.prosecdef));
