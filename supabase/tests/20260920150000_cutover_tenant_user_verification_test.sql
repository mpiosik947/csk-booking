...
begin
  ...
  perform pg_temp.ok(2,'SECURITY DEFINER count is 100 after PRODUCT-10C public landing',(select count(*)=  104 from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='public' and p.prosecdef));
