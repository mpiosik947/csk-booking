...
begin
  ...
  perform pg_temp.ok(29,'SECURITY DEFINER inventory is 75 after PRODUCT-10A public directory',(select pg_catalog.count(*)=75 from pg_catalog.pg_proc procedure join pg_catalog.pg_namespace namespace on namespace.oid=procedure.pronamespace where namespace.nspname='public' and procedure.prosecdef));
