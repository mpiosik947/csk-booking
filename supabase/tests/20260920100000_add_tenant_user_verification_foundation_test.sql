...
begin
  ...
  perform pg_temp.ok(29,'SECURITY DEFINER inventory is 74 after the 9F tenant selector',(select pg_catalog.count(*)=74 from pg_catalog.pg_proc procedure join pg_catalog.pg_namespace namespace on namespace.oid=procedure.pronamespace where namespace.nspname='public' and procedure.prosecdef));
