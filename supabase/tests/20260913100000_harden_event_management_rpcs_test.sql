...
begin
  ...
  perform pg_temp.ok(32,'SECURITY DEFINER inventory reflects PRODUCT-10B public readers',(select count(*)=  100 from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='public' and p.prosecdef),'definer inventory drifted');
end;$tests$;
