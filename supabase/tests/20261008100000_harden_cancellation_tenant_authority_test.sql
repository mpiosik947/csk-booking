...
begin
 ...
 perform pg_temp.check_result('SECURITY DEFINER unchanged',case when (select count(*) from pg_proc where pronamespace='public'::regnamespace and prosecdef)=107 then 'PASS' else 'FAIL' end,'PASS');
end;$test$;
