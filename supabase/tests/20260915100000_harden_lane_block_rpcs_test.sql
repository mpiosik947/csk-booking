...
begin
  ...
  perform pg_temp.ok(33,'SECURITY DEFINER inventory includes 9E-A resolver',(select count(*)=70 from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='public' and p.prosecdef),'Definer count drifted.');
