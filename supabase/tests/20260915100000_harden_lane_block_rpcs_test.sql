...
begin
  ...
  perform pg_temp.ok(33,'SECURITY DEFINER inventory remains at approved post-9D-3C count',(select count(*)=67 from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='public' and p.prosecdef),'Definer count drifted.');
