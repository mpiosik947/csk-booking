...
begin
  ...
  perform pg_temp.ok(12,'SECURITY DEFINER count is 75 after PRODUCT-10A public directory',(select count(*)=75 from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='public' and p.prosecdef));
