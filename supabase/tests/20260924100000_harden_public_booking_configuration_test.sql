...
begin
  ...
  perform pg_temp.ok(12,'SECURITY DEFINER count is 100 after PRODUCT-10C public landing',(select count(*)=  97 from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='public' and p.prosecdef));
