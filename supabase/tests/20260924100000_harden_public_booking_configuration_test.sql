...
begin
  ...
  perform pg_temp.ok(12,'SECURITY DEFINER count is 73 after compatibility retirement',(select count(*)=73 from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='public' and p.prosecdef));
