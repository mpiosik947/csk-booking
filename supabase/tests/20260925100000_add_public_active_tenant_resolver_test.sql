...
begin
  ...
  perform pg_temp.ok(13,'SECURITY DEFINER inventory is exactly 80 after PRODUCT-10C public landing',
    (select pg_catalog.count(*)=80 from pg_catalog.pg_proc p join pg_catalog.pg_namespace n on n.oid=p.pronamespace
