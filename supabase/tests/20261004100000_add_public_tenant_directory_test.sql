...
begin
  ...
  perform pg_temp.ok(9,'SECURITY DEFINER inventory is 100 after PRODUCT-10C',
    (select pg_catalog.count(*)=  104 from pg_catalog.pg_proc procedure join pg_catalog.pg_namespace namespace on namespace.oid=procedure.pronamespace where namespace.nspname='public' and procedure.prosecdef),
