...
begin
  ...
  perform pg_temp.ok(44,'SECURITY DEFINER count is 94 after Phase 2',(select count(*) from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='public' and p.prosecdef)=94,'definer count differs');
