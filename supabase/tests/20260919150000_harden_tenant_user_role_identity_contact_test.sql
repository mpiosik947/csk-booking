...
begin
  ...
  perform pg_temp.ok(44,'SECURITY DEFINER count is 74 after the 9F tenant selector',(select count(*) from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='public' and p.prosecdef)=74,'definer count differs');
