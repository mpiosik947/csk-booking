...
begin
  ...
  perform pg_temp.ok(44,'SECURITY DEFINER count is 100 after PRODUCT-10C public landing',(select count(*) from pg_proc p join pg_namespace n on n.oid=p.pronamespace where n.nspname='public' and p.prosecdef)=  107,'definer count differs');
