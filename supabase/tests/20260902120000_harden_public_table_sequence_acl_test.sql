...
insert into expected_table_acl values
  ('recovery_grants','D','{}','{}','{}'),
  ('platform_admins','D','{}','{}','{}'),
  ('platform_audit_logs','D','{}','{}','{}'),
  ('external_settlement_records','D','{}','{}','{}'),
  ('saas_features','D','{}','{}','{}'),
  ('saas_plans','D','{}','{}','{}'),
  ...
  ('confirmation_email_rate_limits','D','{}','{}','{}'),
  ...
  ('lane_booking_family_configuration_versions','D','{}','{}','{}'),
...
begin
  perform pg_temp.record_result(1,'Complete public table inventory',
    (select count(*)=29 from pg_temp.expected_table_acl)
    and (select count(*)=29 from pg_catalog.pg_class relation join pg_catalog.pg_namespace namespace on namespace.oid=relation.relnamespace where namespace.nspname='public' and relation.relkind in ('r','p')),
