...
// This file runs in Node, not the Next server compiler. Stub only the marker
// for unit tests; separate negative build tests prove client imports are denied.
registerHooks({
...
} = await import("./tenant-context-core.ts");
