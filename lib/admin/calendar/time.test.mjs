...
function sampleRows() {
  return {
    lanes: [
      { id: ACTIVE_LANE_ID, name: "Oś 50 m", is_active: true, display_order: 10, booking_step_minutes: 60, resource_kind: "lane", parent_lane_id: null },
      { id: OLD_LANE_ID, name: "Stara oś", is_active: false, display_order: 90, booking_step_minutes: 60, resource_kind: "lane", parent_lane_id: null },
    ],
    reservations: [
      {
        id: "reservation-1",
